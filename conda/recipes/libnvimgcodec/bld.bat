...
REM CMake installs Debian-style docs for system packages. Conda records license
REM files from meta.yaml, so do not also package the Debian doc directory.
if exist "%LIBRARY_PREFIX%\share\doc\libnvimgcodec" rmdir /s /q "%LIBRARY_PREFIX%\share\doc\libnvimgcodec"
