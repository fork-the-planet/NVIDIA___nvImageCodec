...
docker build -t %REGISTRY_PREFIX%builder-cuda-13.3-vs17-amd64:v%VERSION% -f docker\Dockerfile.cuda133.amd64.vs17.deps .
docker build -t %REGISTRY_PREFIX%builder-cuda-12.9-vs17-amd64:v%VERSION% -f docker\Dockerfile.cuda129.amd64.vs17.deps .

docker push %REGISTRY_PREFIX%builder-cuda-13.3-vs17-amd64:v%VERSION%
